  ...
  module.exports = screens = function(grunt) {
    ...
    return {
      build: function(fn) {
        ...
        if ((screens != null ? (_ref9 = screens.ios) != null ? _ref9.iphoneLandscape736h : void 0 : void 0) != null) {
          grunt.file.copy(screens.ios.iphoneLandscape736h, path.join(res, 'Default-Landscape-736h.png'), {
            encoding: null
          });
        }
        if (fn) {
